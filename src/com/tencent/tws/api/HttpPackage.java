...
public class HttpPackage implements Parcelable{
	...
	public HttpPackage(long mSessionID,String mPackageName,int mPackageType,int statusCode,String mHttpData){
	...
	public static final Parcelable.Creator<HttpPackage> CREATOR = new Parcelable.Creator<HttpPackage>(){  
		  ...
		  return new HttpPackage(source.readLong(),source.readString(),source.readInt(),source.readInt(),source.readString());  
		  }  
		  @Override  
